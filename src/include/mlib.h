...
//MLIB_MULTI_ONLY(OP, 3, a, b, c)
//will be :
//OP(0, a, b, c)
//OP(1, a, b, c)
//OP(2, a, b, c)
#define MLIB_MULTI_ONLY(op, count, ...)                    MLIB_MULTI_IMPL(MLIB_MULTI_ONLY_, op, count, ##__VA_ARGS__)

//MLIB_MULTI_0_EXT(OP, 3, a, b, c)
//will be :
//OP(0, a)
//OP(1, b)
//OP(2, c)
...
//MLIB_MULTI_1_EXT(OP, ext1, 3, a, b, c)
//will be :
//OP(ext1, 0, a)
//OP(ext1, 1, b)
//OP(ext1, 2, c)
...
//MLIB_MULTI_2_EXT(OP, ext1, ext2, 3, a, b, c)
//will be :
//OP(ext1, ext2, 0, a)
//OP(ext1, ext2, 1, b)
//OP(ext1, ext2, 2, c)
...
//MLIB_MULTI_3_EXT(OP, ext1, ext2, ext3, 3, a, b, c)
//will be :
//OP(ext1, ext2, ext3, 0, a)
//OP(ext1, ext2, ext3, 1, b)
//OP(ext1, ext2, ext3, 2, c)
...
#define MLIB_MULTI_ONLY_0(id, pre, op, ...)   op(id, ##__VA_ARGS__)
#define MLIB_MULTI_ONLY_1(id, pre, op, ...)   op(id, ##__VA_ARGS__) MLIB_EXPAND(MLIB_CAT(pre, MLIB_DEC(id))(MLIB_DEC(id), pre, op, ##__VA_ARGS__))
#define MLIB_MULTI_ONLY_2(id, pre, op, ...)   op(id, ##__VA_ARGS__) MLIB_EXPAND(MLIB_CAT(pre, MLIB_DEC(id))(MLIB_DEC(id), pre, op, ##__VA_ARGS__))
#define MLIB_MULTI_ONLY_3(id, pre, op, ...)   op(id, ##__VA_ARGS__) MLIB_EXPAND(MLIB_CAT(pre, MLIB_DEC(id))(MLIB_DEC(id), pre, op, ##__VA_ARGS__))
#define MLIB_MULTI_ONLY_4(id, pre, op, ...)   op(id, ##__VA_ARGS__) MLIB_EXPAND(MLIB_CAT(pre, MLIB_DEC(id))(MLIB_DEC(id), pre, op, ##__VA_ARGS__))
#define MLIB_MULTI_ONLY_5(id, pre, op, ...)   op(id, ##__VA_ARGS__) MLIB_EXPAND(MLIB_CAT(pre, MLIB_DEC(id))(MLIB_DEC(id), pre, op, ##__VA_ARGS__))
#define MLIB_MULTI_ONLY_6(id, pre, op, ...)   op(id, ##__VA_ARGS__) MLIB_EXPAND(MLIB_CAT(pre, MLIB_DEC(id))(MLIB_DEC(id), pre, op, ##__VA_ARGS__))
#define MLIB_MULTI_ONLY_7(id, pre, op, ...)   op(id, ##__VA_ARGS__) MLIB_EXPAND(MLIB_CAT(pre, MLIB_DEC(id))(MLIB_DEC(id), pre, op, ##__VA_ARGS__))
#define MLIB_MULTI_ONLY_8(id, pre, op, ...)   op(id, ##__VA_ARGS__) MLIB_EXPAND(MLIB_CAT(pre, MLIB_DEC(id))(MLIB_DEC(id), pre, op, ##__VA_ARGS__))
#define MLIB_MULTI_ONLY_9(id, pre, op, ...)   op(id, ##__VA_ARGS__) MLIB_EXPAND(MLIB_CAT(pre, MLIB_DEC(id))(MLIB_DEC(id), pre, op, ##__VA_ARGS__))
