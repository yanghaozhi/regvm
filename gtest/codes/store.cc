...
TEST(code, store)
{
    tester t([](auto key, auto offset, auto info)
        ...
        [](auto key, auto offset, auto info)
        {
            ...
            CHECK_VAR(key, 3, 1, 0, 0, 2,  TYPE_UNSIGNED, 321, 2, 0);

            CHECK_VAR(key, 4, 1, 0, 0, 2,  TYPE_UNSIGNED, 456, 2, 0);

            CHECK_VAR(key, 5, 1, 0, 0, -1, TYPE_UNSIGNED, 456, 1, 0);
            CHECK_VAR(key, 5, 2, 0, 0, 2,  TYPE_UNSIGNED, 456, 2, 0);
            return match;
