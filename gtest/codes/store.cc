    ...
    tester t([](auto key, auto offset, auto info)
        {
            ...
            CHECK_REG(key, 3, 2, Y, TYPE_UNSIGNED, 456,     2);

            CHECK_REG(key, 4, 2, Y, TYPE_UNSIGNED, 456,     2);

            CHECK_REG(key, 5, 2, Y, TYPE_UNSIGNED, 456,     2);
        ...
        [](auto key, auto offset, auto info)
        {
            ...
            CHECK_VAR(key, 3, "abc", 0, 0, 2,  TYPE_UNSIGNED, 321, 2);

            CHECK_VAR(key, 4, "abc", 0, 0, 2,  TYPE_UNSIGNED, 456, 2);

            CHECK_VAR(key, 5, "abc", 0, 0, -1, TYPE_UNSIGNED, 456, 1);
            CHECK_VAR(key, 5, "def", 0, 0, 2,  TYPE_UNSIGNED, 456, 2);
            return match;
