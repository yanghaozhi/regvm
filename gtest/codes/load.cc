    ...
    tester t([](auto key, auto offset, auto info)
        {
            ...
            CHECK_REG(key, 0, 4, N, TYPE_ADDR,      1,   -1, 0);
        ...
        [](auto key, auto offset, auto info)
        {
            ...
            CHECK_VAR(key, 1, 1, 0, 0, 1,   TYPE_SIGNED,    123, 2, 0);

            CHECK_VAR(key, 2, 1, 0, 0, 6,   TYPE_SIGNED,    123, 2, 0);

            CHECK_VAR(key, 3, 2, 0, 1, 3,   TYPE_DOUBLE,    321.123, 2, 0);

            CHECK_VAR(key, 4, 1, 0, 0, 6,   TYPE_SIGNED,    123, 2, 0);
            CHECK_VAR(key, 4, 1, 0, 1, 2,   TYPE_UNSIGNED,  321, 2, 0);

            CHECK_VAR(key, 5, 1, 0, 0, 6,   TYPE_SIGNED,    123, 2, 0);
            CHECK_VAR(key, 5, 1, 0, 1, 7,   TYPE_UNSIGNED,  321, 2, 0);

            CHECK_VAR(key, 6, 1, 0, 0, 6,   TYPE_SIGNED,    123, 2, 0);
            CHECK_VAR(key, 6, 1, 0, 1, 7,   TYPE_UNSIGNED,  321, 2, 0);

            CHECK_VAR(key, 7, 1, 0, 1, 7,   TYPE_UNSIGNED,  321, 2, 0);
            CHECK_VAR(key, 7, 2, 0, 1, 7,   TYPE_DOUBLE,    321.123, 2, 0);

            CHECK_VAR(key, 8, 1, 0, 0, 8,   TYPE_SIGNED,    123, 2, 0);
            return match;
        });
