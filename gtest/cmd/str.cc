...
TEST(cmd, str)
{
    tester t([](auto key, auto offset, auto info)
        ...
        {
            int match = 0;
            CHECK_VAR(key, 5, 1, 0, 0, 5,  TYPE_STRING, "def", 2, 0);

            CHECK_VAR(key, 6, 1, 0, 0, 6,  TYPE_STRING, "qwerzxcv", 2, 0);
            return match;
        });
