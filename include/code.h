...
//  上一条非DATA指令的附加数据
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| SET     | CODE_SET      | reg                   | type of data          | first byte of data    |
...
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| INC     | CODE_INC      | result                | a                     | b                     |
//  $result = $a + b ( -128 <= b <= 127 )
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| ADD     | CODE_ADD      | result                | a                     | b                     |
//  $result = $a + $b
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| SUB     | CODE_SUB      | result                | a                     | b                     |
//  $result = $a - $b
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| MUL     | CODE_MUL      | result                | a                     | b                     |
//  $result = $a * $b
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| DIV     | CODE_DIV      | result                | a                     | b                     |
//  $result = $a / $b
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| MOD     | CODE_MOD      | result                | a                     | b                     |
//  $result = $a % $b
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| AND     | CODE_AND      | result                | a                     | b                     |
//  $result = $a & $b
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| OR     | CODE_OR        | result                | a                     | b                     |
//  $result = $a | $b
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| XOR     | CODE_XOR      | result                | a                     | b                     |
//  $result = $a ^ $b
//+---------+---------------+-----------------------+-----------------------+-----------------------+
...
//  把$ex的类型的值存入$result中（类型为TYPE_UNSIGNED）
//+---------+---------------+-----------------------+-----------------------+-----------------------+
...
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| JEQ      | CODE_JEQ     | dest                  | a                     | b                     |
//  if ($a == $b) jump $dest
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| JNE     | CODE_JNE      | dest                  | a                     | b                     |
//  if ($a != $b) jump $dest
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| JGT     | CODE_JGT      | dest                  | a                     | b                     |
//  if ($a > $b) jump $dest
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| JGE     | CODE_JGE      | dest                  | a                     | b                     |
//  if ($a >= $b) jump $dest
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| JLT     | CODE_JLT      | dest                  | a                     | b                     |
//  if ($a < $b) jump $dest
//+---------+---------------+-----------------------+-----------------------+-----------------------+
//| JLE     | CODE_JLE      | dest                  | a                     | b                     |
//  if ($a <= $b) jump $dest
//+---------+---------------+-----------------------+-----------------------+-----------------------+
...
//  CODE_EXIT   = 255,  //退出执行, exitcode = (reg != 0) ? $reg : code
//+---------+---------------+-----------------------+-----------------------+
